			        ...
			        <div <?php if($i == 1){echo 'class="carousel-item fade-in-image active"';} else{ echo 'class="carousel-item fade-in-image"';}?>>
			        	...
			        	<div class="container">
				            ...
				            <div class="inner-carousel">
				              	...
				              	<p><?php $expert_electrician_excerpt = get_the_excerpt(); echo esc_html( expert_electrician_string_limit_words( $expert_electrician_excerpt, esc_attr(get_theme_mod('expert_electrician_slider_excerpt_length','20') ) )); ?></p>
		            		</div>
			          	</div>
			        </div>
			      	<?php $i++; endwhile; 
				...
				<div class="row">
	  				...
	  				if($expert_electrician_category){ 
		        		...
		        		<?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>	
		          			<div class="col-lg-3 col-md-6" style="padding:10px 8px;">
