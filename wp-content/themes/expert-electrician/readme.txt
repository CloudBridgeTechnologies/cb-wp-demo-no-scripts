...
= 2.0 =
  - Added Note in Features & Services Section Customizer.
  - Updated pot file.
...
= 2.3 =
  - Added more color options for header in Customizer.
  - Fixed some errors.

= 2.4 =
  - Added more color options for slider section.
  - Fixed some errors.